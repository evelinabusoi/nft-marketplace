...
const style = {
  ...
  headerItem:
    'text-white px-4 font-bold text-[#c8caco] hover:text-white cursor-pointer',
  headerIcon:
    ...
    <div className={style.wrapper}>
      <Link href="/">
        <div className={style.logoContainer}>
          <Image src={Logo} height={40} width={40} className="rounded-full" />
          <div className={style.logoText}>Cleomar</div>
        </div>
      </Link>
      ...
      <div className={style.headerItems}>
        <Link href="/collections/0x45a57eC79b7fa36475527390c93ad7b5f812B2b4">
